...
import '../../controller/services/orderServices/orderServices.dart';
                          ...
                          Row(
                            ...
                            children: [
                              Row(
                                children: [
                                  Text(
                                    '${(((double.parse(foodData.foodDetails.actualPrice) - double.parse(foodData.foodDetails.discountedPrice)) / double.parse(foodData.foodDetails.actualPrice)) * 100).round().toString()} %',
                                    style: AppTextStyles.body14Bold,
                                  ),
                                  SizedBox(
                                    width: 2.w,
                              ...
                              Column(
                                children: [
                                  Text(
                                    '${foodData.foodDetails.actualPrice} VNĐ',
                                  ...
                                  Text(
                                    '${foodData.foodDetails.discountedPrice} VNĐ',
                                    style: AppTextStyles.body16Bold,
                                  ),
                                ],
                              ),
