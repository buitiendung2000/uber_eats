                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Row(
                                        children: [
                                          Text(
                                            '${(((double.parse(currentFoodData.foodDetails.actualPrice) - double.parse(currentFoodData.foodDetails.discountedPrice)) / double.parse(currentFoodData.foodDetails.actualPrice)) * 100).round().toString()} %',
                                            style: AppTextStyles.body14Bold,
                                          ),
                                          SizedBox(
                                            width: 2.w,
                                      ...
                                      Column(
                                        children: [
                                          Text(
                                            '${currentFoodData.foodDetails.actualPrice} VNĐ',
                                            style:
                                          ...
                                          Text(
                                            '${currentFoodData.foodDetails.discountedPrice} VNĐ',
