...
void main() => runApp(const PayCardView());

class PayCardView extends StatefulWidget {
  const PayCardView({super.key});

  @override
  State<StatefulWidget> createState() => PayCardViewState();
}

class PayCardViewState extends State<PayCardView> {
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: ExactAssetImage(
                    isLightTheme ? 'assets/images/creditCard/bg-light.png' : 'assets/images/creditCard/bg-dark.png',
                  ),
                  fit: BoxFit.fill,
                ),
              ),
